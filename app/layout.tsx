        ...
        <nav className="border-b border-system-border bg-background/80 backdrop-blur-md sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
            ...
            <div className="flex items-center gap-8 text-[10px] uppercase tracking-[0.2em] text-gray-500">
              ...
              <a 
                href="/blog" 
                className="relative px-4 py-1.5 bg-system-green-5 border border-system-green-30 text-system-green hover:bg-system-green hover:text-black transition-all duration-300 flex items-center gap-2 group"
              >
                {/* Live Status Pulse */}
                ...
                <div className="absolute top-0 right-0 w-2 h-2 bg-system-green-20 hover:bg-system-green" />
              </a>
            </div>
          </div>
        </nav>
